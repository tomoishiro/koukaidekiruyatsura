module mdl_003_energies
   ...
   double precision, parameter :: theta = (pi*0.5d0)*0.123d0 !complex-scaling angle
   !---
   double precision, parameter :: recent  =  0.43138d0!MeV
   double precision, parameter :: gapr    =  0.00018d0
   double precision, parameter ::   de    =  0.00001d0
!<>   double precision, parameter :: gapr   =  0.018d0
!<>   double precision, parameter ::   de   =  0.001d0
   ...
   !---
   double precision, parameter :: eicent  = -0.00768d0!MeV
   double precision, parameter :: gapi    =  0.00018d0
   double precision, parameter ::   dg    =  0.00001d0
!<>   double precision, parameter :: gapi    =  0.018d0
!<>   double precision, parameter ::   dg    =  0.001d0
